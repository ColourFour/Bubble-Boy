...
export function resolveToyboxPresentationState(worldState) {
  ...
  return {
    ...
    debug: {
      ...
      selectedAnimationEmoteState: animation.attentionEmote ? animation.attentionEmote.state || "" : "",
      selectedAnimationEmoteClip: animation.attentionEmote ? animation.attentionEmote.clip || animation.clip || "" : animation.clip || "",
      selectedAnimationEmoteName: animation.attentionEmote ? animation.attentionEmote.emote || "" : animation.emote || "",
      selectedAnimationEmoteOverlay: animation.emoteOverlay || "",
      selectedAnimationEmoteIntensity: animation.attentionEmote ? Number(animation.attentionEmote.intensity || 0) : 0,
      selectedAnimationEmoteRootMotion: animation.attentionEmote ? Boolean(animation.attentionEmote.rootMotion) : false,
      selectedAnimationLocomotionState: animation.locomotion ? animation.locomotion.state || "" : "",
      selectedAnimationLocomotionOverlay: animation.locomotionOverlay || "",
      selectedAnimationLocomotionClip: animation.locomotion ? animation.locomotion.clip || animation.clip || "" : animation.clip || "",
      selectedAnimationLocomotionTimeScale: animation.locomotion ? Number(animation.locomotion.timeScale || 1) : 1,
      selectedAnimationLocomotionSpeed: animation.locomotion ? Number(animation.locomotion.speed || 0) : 0,
      selectedAnimationLocomotionGaitSpeed: animation.locomotion ? Number(animation.locomotion.gaitSpeed || 0) : 0,
      selectedAnimationLocomotionFootSlideRatio: animation.locomotion ? Number(animation.locomotion.footSlideRatio || 0) : 0,
      selectedAnimationLocomotionFootSlideOk: animation.locomotion ? Boolean(animation.locomotion.footSlideOk) : true,
      selectedAnimationLocomotionTargetId: animation.locomotion ? animation.locomotion.targetId || "" : "",
      selectedAnimationLocomotionRootMotion: animation.locomotion ? Boolean(animation.locomotion.rootMotion) : false,
